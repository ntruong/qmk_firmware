...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ansi(
      ...
      LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K,    KC_L,   LT(2, KC_SCLN), KC_QUOT, KC_ENT,           KC_VOLD,
  ...
  [1] = LAYOUT_ansi(
      ...
      _______, _______, RGB_SAI, _______, _______, _______, RGB_HUI, _______, _______, _______, _______, _______, _______,          KC_F14,
      KC_CAPS, _______, _______, _______, RGB_VAI, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
      _______, _______, _______, KC_MPLY, RGB_TOG, RGB_MOD,                                                       KC_MPRV, KC_MUTE, KC_MNXT
  ),
