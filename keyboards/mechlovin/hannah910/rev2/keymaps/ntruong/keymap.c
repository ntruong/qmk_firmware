...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ansi_7u(
      ...
      _______, _______, RGB_SAI, _______, _______, _______, RGB_HUI, _______, _______, _______, _______, _______, RGB_TOG,          KC_F14,
      KC_CAPS, _______, _______, _______, RGB_VAI, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
      _______, _______, _______, KC_MPLY,                                                                RGB_MOD, KC_MPRV, KC_MUTE, KC_MNXT
  ),
