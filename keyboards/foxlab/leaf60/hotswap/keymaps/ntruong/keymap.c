...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Layer 1: Function, arrow, and system keys
   *
   * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐
  ...
  [1] = LAYOUT_60_tsangan_hhkb(
      ...
      _______, _______, _______, KC_END,  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,
  ...
  /* Layer 2: Miscellaneous system keys
   *
   * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┐
   * │ ⟳ │   │   │   │   │   │   │   │   │   │   │   │   │   │   │
   * ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴───┤
  ...
  [2] = LAYOUT_60_tsangan_hhkb(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      BL_BRTG, _______, _______, BL_TOGG, BL_DEC,  _______, BL_INC
      )
};
